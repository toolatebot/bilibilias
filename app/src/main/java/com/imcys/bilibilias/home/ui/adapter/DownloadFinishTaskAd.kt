...
import com.imcys.bilibilias.home.ui.activity.video.PlayLocalVideoActivity
...
//                            }
                            ...
                            val intent = Intent(holder.itemView.context,PlayLocalVideoActivity::class.java)
                            intent.apply {
                                putExtra("videoPath", task.savePath)
                            }
